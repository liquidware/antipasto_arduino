...
public class Target {
  ...
  List objects = new ArrayList();
    ...
    //making it work....change this
    static private String lastActualTarget;
  ...
  public Target(String base, String target) throws IOException {
    ...
    if (files == null){
        if(lastActualTarget == null || lastActualTarget.equalsIgnoreCase("null")){
      throw new IOException("Target platform: \"" + target + "\" not found.\n" +
            ...
            target = lastActualTarget;
        }
    }
        lastActualTarget = target;
