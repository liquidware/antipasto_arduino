...
public class Wing extends JDialog implements ComponentListener,
    ...
    JPanel initWingBody() {
        ...
        String scriptPath = new String(Base.getSketchbookFolder().getPath() + File.separator);
    ...
    private void setLocation() {
        if (this.isVisible() && ((Editor) component).centerPanel.isVisible()) {
            ...
            Component lineStatus =((Editor) component).getLineStatus();
    ...
    public String getLastBoardReferenceURL() {
    ...
    public void onActiveBoardChanged(ActiveBoardObject obj) {
        if (obj != null) {
            refURL = obj.getReferenceURL();
            loadBoardReference(refURL);
        }
    }
